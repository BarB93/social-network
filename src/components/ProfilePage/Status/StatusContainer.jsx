...
const StatusContainer = ({userId}) => {
    ...
    const closeOtherElements = () => {dispatch(closeMenu())}
    ...
    return (
        <>
            ...
            {status && <Status ref={statusRef} status={status} isConditional={isConditional}
                               openUpdateStatus={openChangeStatus} closeOtherElements={closeOtherElements}/>}
        </>
    )
}
